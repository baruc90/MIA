...
tk.Button(categoria1, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria1, text="Permite ejecutar varias soluciones de red", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria1, text="Ejecución Rápida", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Button(categoria2, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria2, text="Permite mejorar le eficiencia de este equipo", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria2, text="Mejora Rapido", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Label(categoria3, text="Emite información útil que equipo", font=fuente_definida2).pack(anchor="w")
tk.Button(categoria3, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria3, text="Permite ejecutar varios diagnósticos", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria3, text="diagnóstico Rapido", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Button(categoria4, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria4, text="Ejecuta una limpieza profunda a este equipo", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria4, text="Limpieza Rapida", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Button(categoria5, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria5, text="Entrar a las opciones de actualización", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria5, text="Forzar actualización", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Button(categoria6, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria6, text="Entrar para configurar tu firewall y seguridad", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria6, text="Análisis de antivirus", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Button(categoria7, text="Entrar", font=fuente_definida3).pack(anchor="w", side="left")
tk.Label(categoria7, text="Revisar la información de este equipo", font=fuente_definida3).pack(anchor="w", side="left")
tk.Button(categoria7, text="Emitir informe", font=fuente_definida3).pack(anchor="w", side="right")
...
tk.Label(categoria8, text="Programa el apagado o gestiona algunos servicios entre algunos", font=fuente_definida2).pack(anchor="w")
tk.Button(categoria8, text="Entrar", font=fuente_definida3).pack(anchor="w")
